...
const Prodotti = () => {
  ...
  //creoo un array filtrato se presente budgetmode 
  let visibleProducts = prodotti;
  if (budgetMode && budgetLimit > 0) {
    visibleProducts = prodotti.filter(p => p.price < budgetLimit);
  }
    ...
    <div className="container section-light">
      <div className="row mt-5">
        ...
        {visibleProducts.length > 0 ? (
          ...
          <p className="text-center mt-5 text-muted">Nessun risultato trovato.</p>
        )}
      </div>
    </div>
  );
